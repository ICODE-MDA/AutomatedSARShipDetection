...
//
//----------------------------------------------------------------------------
// $Id: ossimKakaduCompressor.cpp 21259 2012-07-09 11:34:06Z dburken $
                                      ...
                                      ossim_int32 levels)
{
   ...
   if (cod)
   {
      if (levels == 0)
      {
         levels = ossim::computeLevels(imageRect);
         if (levels == 0)
         {
...
{
   ossimString s = "ORGgen_tlm=";
   s += ossimString::toString(tilesToWrite);
