...
//
//----------------------------------------------------------------------------
// $Id: ossimKakaduNitfOverviewBuilder.cpp 21693 2012-09-11 15:20:38Z dburken $
...
static const char OSSIM_ID[] = "$Id: ossimKakaduNitfOverviewBuilder.cpp 21693 2012-09-11 15:20:38Z dburken $";
#endif
         ...
         if ( startingResLevel < requiedResLevels )
         {
            ...
            if ( os->good() )
            {
               ...
               if ( result )
               {
                  ...
                  // If masking was enabled, then only R0 was processed, need to process remaining levels:
                  if (m_maskWriter.valid())
                  {
                     ...
                     ossimNotify(ossimNotifyLevel_INFO)<<MODULE<<"Writing alpha bit mask file..." 
                        << std::endl;
                     m_maskWriter->close();
                  }
